...
2. div1 attributes, each with form name=value separated by pipes (e.g. xml:id=d001|type=section|decls=#md|met=H). This assumes that no attribute value contains a pipe. An error will be logged by the partitioner if this happens.
